...
public class PublicationEditAction extends ActionSupport implements IEditAction, Action, SessionAware{
	...
	public String save(){
		...
		publication.setAuthor(((Publication)session.get("publicationEdit")).getAuthors());
		publication.setKeywords(((Publication)session.get("publicationEdit")).getKeywords());
